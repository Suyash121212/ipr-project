      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-300 text-lg font-medium">
                Track and manage your intellectual property applications
              </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={goHome}
              className="group relative bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-teal-500/25 font-medium flex items-center gap-2 border border-white/20 overflow-hidden"
            >
            ...
            <button
              ...
              className="group relative bg-white/10 hover:bg-white/20 disabled:opacity-50 text-white px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2 backdrop-blur-sm border border-white/20 hover:border-white/30 hover:shadow-lg overflow-hidden"
            >
              <RefreshCw
                className={`h-5 w-5 ${
